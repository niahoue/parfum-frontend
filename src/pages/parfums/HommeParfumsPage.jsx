// src/pages/parfums/HommeParfumsPage.jsx
      ...
      {loading ? (
        ...
        <div className="text-center py-10 text-red-600">
          ...
          {error.includes("Catégorie") && (
            <p className="mt-4 text-gray-700">Veuillez vous assurer qu'une catégorie nommée "Homme" existe et contient des produits.</p>
          )}
        </div>
      ) : products.length === 0 ? (
        <div className="text-center text-gray-600 py-10">
          Aucun parfum homme trouvé pour le moment.
        </div>
      ) : (
