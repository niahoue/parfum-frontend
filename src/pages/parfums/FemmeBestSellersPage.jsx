// src/pages/parfums/FemmeBestSellersPage.jsx
  ...
  useEffect(() => {
    const fetchBestSellers = async () => {
      ...
      try {
        ...
        // Récupérer les produits qui sont des best-sellers et de la catégorie "Femme"
      ...
      {loading ? (
        ...
        <div className="text-center py-10 text-red-600">
          ...
          {error.includes("Catégorie") && (
            <p className="mt-4 text-gray-700">Veuillez vous assurer qu'une catégorie nommée "Femme" existe et contient des produits best-sellers.</p>
          )}
        </div>
      ) : products.length === 0 ? (
        <div className="text-center text-gray-600 py-10">
          Aucun parfum best-seller pour femme trouvé pour le moment.
        </div>
      ) : (
